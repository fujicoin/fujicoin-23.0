...
- Full support has been added for the CJDNS network. See the new option `-cjdnsreachable` and [doc/cjdns.md](https://github.com/fujicoin/fujicoin/tree/master/doc/cjdns.md) (#23077)
...
[doc/tracing.md](https://github.com/fujicoin/fujicoin/tree/master/doc/tracing.md) and
usage examples are provided in [contrib/tracing/](https://github.com/fujicoin/fujicoin/tree/master/contrib/tracing).
